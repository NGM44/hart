    ...
    return Container(
      ...
      child: Column(
        children: [
            Row(
            children: [
              Text('Manufacturer Name:'), //lCLVALUE != 0.0 ?
             Flexible(child: Text('$manufacture'))
          ...
          Row(
            children: [
              Text('LCL UCL cmmd o/p'), //lCLVALUE != 0.0 ?
             Flexible(child: Text('$fetchlcluclCMDData'))
