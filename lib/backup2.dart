...
class _ChatPage extends State<ChatPage> {
  ...
  void _submitForm3() async {
    isValidUCLLCL = validateUcl() && validateUcl();
                      ...
                      await showDialog(
                          ...
                          builder: (BuildContext context) => StatefulBuilder(builder: (context, setStateModal) {
                                return AlertDialog(
                                          ...
                                          Form(
                                            ...
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  errorText: validateUcl() ? null : 'Enter the Value',
                                                  contentPadding: EdgeInsets.fromLTRB(30, 30, 30, 8),
                                                  border: const UnderlineInputBorder(),
                                                  filled: true,
                                                  hintText: 'UCL value',
                                  ...
                                  actions: <Widget>[
                                    //ElevatedButton(onPressed: _submitForm3, child: Text('SET UCL & LCL')),
                                    ElevatedButton(
                                      onPressed: () {
                                        setState(() {
                                          ucllclFlag = false;
